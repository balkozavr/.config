...
vim.keymap.set("n", "<leader>bo", "<cmd>%bd|e#<CR>", { desc = "Buffer Delete Other", silent = true })
vim.keymap.set("n", "<leader>ba", "<cmd>%bd<CR>", { desc = "Buffer Delete All", silent = true })
...
vim.keymap.set({ "n", "v", "x" }, "<leader>d", [["_d]], { desc = "Paste Clipboard" })
